...
* With the [Windows Subsytem for Linux](https://docs.microsoft.com/en-us/windows/wsl/) (WSL), you can run a linux right in a console
* The [GNU coreutils](https://www.gnu.org/software/coreutils)
* [Cygwin](https://www.cygwin.com)
* [GNUWin](http://gnuwin32.sourceforge.net/summary.html)
