...
This is the I<README> for the L<PerlPowerTools> Perl module. You're probably 
...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/PerlPowerTools> or 
L<MetaCPAN|http://www.metacpan.org/module/PerlPowerTools>:

=over 4

=item *	L<http://search.cpan.org/dist/PerlPowerTools>

=item *	L<http://www.metacpan.org/module/PerlPowerTools>
